      ...
      <section className="wrapper py-12 flex flex-col gap-6">
        ...
        <div className="flex items-center gap-8">
          <p className="hidden md:flex">
            ...
            within Islam, including theology, history, spirituality, and more
          </p>
          <p>
            እንኳን በደህና መጡ ወደ የእስልምና እውቀት ዋና መዳረሻዎ ዘቢብ ዲጂታል ቅርጸት. የእኛ መድረክ የተዘጋጀ
            የተዘጋጀ ለማቅረብ ነው። የተለያዩ ርዕሰ ጉዳዮችን የሚሸፍኑ ከፍተኛ ጥራት ያላቸውን ኢ-መጽሐፍት መምረጥ
            በእስልምና ውስጥ፣ ስነ መለኮትን፣ ታሪክን፣ መንፈሳዊነትን እና ሌሎችንም ጨምሮ
          </p>
        </div>
        <div className="flex items-center gap-8">
          <p>
            በዘቢብ፣ ለመፍቀድ፣ ተደራሽነትን እና ምቾትን እናስቀድማለን። በማንኛውም ጊዜ እና በማንኛውም ቦታ በራስዎ
          ...
          <p className="hidden md:flex">
            ...
            engage with valuable Islamic literature from renowned scholars and
            authors.
          </p>
        </div>
        <div className="flex items-center gap-8">
          ...
          <p>
            በዚህ የበለጸገ የእውቀት እና የመንፈሳዊ እድገት ጉዞ ላይ ይቀላቀሉን። ዘቢብ ስለ እስልምና ያለህን ግንዛቤ
            ለማሳደግ ታማኝ ጓደኛህ ነው። እና ጥልቅ ትምህርቶቹ።
          </p>
        </div>
      </section>
    </main>
